...
export default function HomePage() {
  return <><SiteHeader /><main>
    ...
    <section className="signal-strip"><div className="shell signal-grid"><div><b>22</b><span>已核验实战教程</span></div><div><b>AI × 跨境</b><span>首个垂直增长赛道</span></div><div><b>公开作品</b><span>默认公开，作者可随时撤回</span></div><div><b>真实挑战</b><span>企业问题即将开放</span></div></div></section>
